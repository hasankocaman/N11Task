...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Automation Engineer", "N11 ");
        extentHtmlReporter.config().setDocumentTitle("N11 Test");
        extentHtmlReporter.config().setReportName("n11.com Test Reports");
    }
